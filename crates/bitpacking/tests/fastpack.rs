...
fn fastpack0() {
    ...
    fastpack(&TEST_DATA, 0, &mut output, 0, 0);
...
fn fastpack1() {
    ...
    fastpack(&TEST_DATA, 0, &mut output, 0, 1);
...
fn fastpack2() {
    ...
    fastpack(&TEST_DATA, 0, &mut output, 0, 2);
...
fn fastpack3() {
    ...
    fastpack(&TEST_DATA, 0, &mut output, 0, 3);
...
fn fastpack4() {
    ...
    fastpack(&TEST_DATA, 0, &mut output, 0, 4);
...
fn fastpack5() {
    ...
    fastpack(&TEST_DATA, 0, &mut output, 0, 5);
...
fn fastpack6() {
    ...
    fastpack(&TEST_DATA, 0, &mut output, 0, 6);
...
fn fastpack7() {
    ...
    fastpack(&TEST_DATA, 0, &mut output, 0, 7);
...
fn fastpack8() {
    ...
    fastpack(&TEST_DATA, 0, &mut output, 0, 8);
...
fn fastpack9() {
    ...
    fastpack(&TEST_DATA, 0, &mut output, 0, 9);
...
fn fastpack10() {
    ...
    fastpack(&TEST_DATA, 0, &mut output, 0, 10);
...
fn fastpack11() {
    ...
    fastpack(&TEST_DATA, 0, &mut output, 0, 11);
...
fn fastpack12() {
    ...
    fastpack(&TEST_DATA, 0, &mut output, 0, 12);
...
fn fastpack13() {
    ...
    fastpack(&TEST_DATA, 0, &mut output, 0, 13);
...
fn fastpack14() {
    ...
    fastpack(&TEST_DATA, 0, &mut output, 0, 14);
...
fn fastpack15() {
    ...
    fastpack(&TEST_DATA, 0, &mut output, 0, 15);
...
fn fastpack16() {
    ...
    fastpack(&TEST_DATA, 0, &mut output, 0, 16);
...
fn fastpack17() {
    ...
    fastpack(&TEST_DATA, 0, &mut output, 0, 17);
...
fn fastpack18() {
    ...
    fastpack(&TEST_DATA, 0, &mut output, 0, 18);
...
fn fastpack19() {
    ...
    fastpack(&TEST_DATA, 0, &mut output, 0, 19);
...
fn fastpack20() {
    ...
    fastpack(&TEST_DATA, 0, &mut output, 0, 20);
...
fn fastpack21() {
    ...
    fastpack(&TEST_DATA, 0, &mut output, 0, 21);
...
fn fastpack22() {
    ...
    fastpack(&TEST_DATA, 0, &mut output, 0, 22);
...
fn fastpack23() {
    ...
    fastpack(&TEST_DATA, 0, &mut output, 0, 23);
...
fn fastpack24() {
    ...
    fastpack(&TEST_DATA, 0, &mut output, 0, 24);
...
fn fastpack25() {
    ...
    fastpack(&TEST_DATA, 0, &mut output, 0, 25);
...
fn fastpack26() {
    ...
    fastpack(&TEST_DATA, 0, &mut output, 0, 26);
...
fn fastpack27() {
    ...
    fastpack(&TEST_DATA, 0, &mut output, 0, 27);
...
fn fastpack28() {
    ...
    fastpack(&TEST_DATA, 0, &mut output, 0, 28);
...
fn fastpack29() {
    ...
    fastpack(&TEST_DATA, 0, &mut output, 0, 29);
...
fn fastpack30() {
    ...
    fastpack(&TEST_DATA, 0, &mut output, 0, 30);
...
fn fastpack31() {
    ...
    fastpack(&TEST_DATA, 0, &mut output, 0, 31);
...
fn fastpack32() {
    ...
    fastpack(&TEST_DATA, 0, &mut output, 0, 32);
...
fn fastpack33() {
    ...
    fastpack(&TEST_DATA, 0, &mut output, 0, 33);
}